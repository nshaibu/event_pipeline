...
_lr_productions = [
    ...
    ("expression -> term", "expression", 1, "p_expression_term", "grammar.py", 26),
    ("term -> task", "term", 1, "p_task", "grammar.py", 33),
    ("descriptor -> DESCRIPTOR", "descriptor", 1, "p_descriptor", "grammar.py", 40),
    ("task -> TASKNAME", "task", 1, "p_task_taskname", "grammar.py", 48),
    (
        "task -> task LPAREN expression SEPERATOR expression RPAREN",
        "task",
        6,
